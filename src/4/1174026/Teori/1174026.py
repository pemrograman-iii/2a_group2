...
with open('teori2.csv', mode='w') as csv_file:
    ...
    csv_writer.writerow(['1174002', 'Bambang', 'D4TI2C'])
    csv_writer.writerow(['1174003', 'Butet', 'D4TI2B'])
...
with open('teori3.csv', mode='w') as csv_file:
    ...
    writer.writeheader()
    writer.writerow({'npm': '1174009', 'nama': 'Bambang', 'kelas': 'D4TI2A'})
    writer.writerow({'npm': '1174010', 'nama': 'Butet', 'kelas': 'D4TI2A'})
