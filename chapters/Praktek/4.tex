...
Fungsi yang menggunakan try except
\lstinputlisting[caption= Fungsi yang menggunakan try except .,firstline=55, lastline=67]{src/4/1174026/Teori/1174026.py}
...
\lstinputlisting[firstline=10, lastline=15]{src/4/1174017/praktek/17_csv.py}

\subsection{Berikut adalah pemanggilan file csv dengan library csv yang menggunakan dictionary}
\lstinputlisting[firstline=17, lastline=22]{src/4/1174017/praktek/17_csv.py}

\subsection{Berikut adalah pemanggilan file csv dengan library pandas yang menggunakan list}
\lstinputlisting[firstline=10, lastline=13]{src/4/1174017/praktek/17_pandas.py}

\subsection{Berikut adalah pemanggilan file csv dengan library pandas yang menggunakan dictionary}
\lstinputlisting[firstline=15, lastline=19]{src/4/1174017/praktek/17_pandas.py}

\subsection{Berikut penggunaan untuk merubah standar penulisan tanggal, yang mengikuti standar penulisan dari pandas.}
\lstinputlisting[firstline=21, lastline=24]{src/4/1174017/praktek/17_pandas.py}

\subsection{Berikut merupakan pergantian index kolom}
\lstinputlisting[firstline=26, lastline=30]{src/4/1174017/praktek/17_pandas.py}

\subsection{berikut merupakan penggunaan untuk merename atribut yang digunakan, atau merubah nama header 0}
\lstinputlisting[firstline=32, lastline=44]{src/4/1174017/praktek/17_pandas.py}

\subsection{Soal 8}
\lstinputlisting[firstline=8, lastline=13]{src/4/1174017/praktek/main.py}

\subsection{Soal 9}
\lstinputlisting[firstline=8, lastline=13]{src/4/1174017/praktek/main2.py}
