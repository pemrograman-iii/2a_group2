# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 21:24:01 2019
...
y = [4,7,9]
plt.plot(x,y)
plt.ylabel('Sumbu Y Coy')
plt.xlabel('Sumbu X Coy')
plt.show()
...
Cabe = [10,20,35,50,78,79,11,15,45,36,79,55]
Jumlah = [0,10,20,30,40,50,70,80]
plt.hist(Cabe, Jumlah, histtype='bar', width=2.8)
plt.xlabel('Cabe')
plt.ylabel('jumlah')
